    ...
    <Layout>
      ...
      <section className="pt-32 lg:pt-40 pb-20 px-6 lg:px-12">
        <div className="max-w-3xl mx-auto">
          <nav className="mb-8">
            <ol className="flex gap-2 text-sm text-slate">
              <li><Link to="/" className="hover:text-teal transition-colors">Home</Link></li>
              <li>/</li>
              <li className="text-ink">Terms of Service</li>
            </ol>
          </nav>

          <h1 className="font-display text-4xl lg:text-5xl font-extrabold mb-4 text-ink">Terms of Service</h1>
          <p className="text-slate mb-12">Last updated: December 2024</p>
          ...
          <div className="space-y-8 text-slate leading-relaxed">
            ...
            <section>
              <h2 className="font-display text-2xl font-bold text-ink mb-4">2. Use of Services</h2>
            ...
            <section>
              <h2 className="font-display text-2xl font-bold text-ink mb-4">3. Products and Pricing</h2>
            ...
            <section>
              <h2 className="font-display text-2xl font-bold text-ink mb-4">4. Accounts</h2>
            ...
            <section>
              <h2 className="font-display text-2xl font-bold text-ink mb-4">5. Intellectual Property</h2>
            ...
            <section>
              <h2 className="font-display text-2xl font-bold text-ink mb-4">6. User Content</h2>
            ...
            <section>
              <h2 className="font-display text-2xl font-bold text-ink mb-4">7. Disclaimers</h2>
            ...
            <section>
              <h2 className="font-display text-2xl font-bold text-ink mb-4">8. Limitation of Liability</h2>
            ...
            <section>
              <h2 className="font-display text-2xl font-bold text-ink mb-4">9. Governing Law</h2>
            ...
            <section>
              <h2 className="font-display text-2xl font-bold text-ink mb-4">11. Contact Us</h2>
              <p>If you have questions about these Terms, please contact us at:</p>
              <p className="mt-4">
                <strong className="text-ink">Email:</strong> hello@autaimate.com<br />
                <strong className="text-ink">Location:</strong> United Kingdom
              </p>
            </section>
          </div>
        </div>
