    ...
    <Layout>
      ...
      <section className="pt-32 lg:pt-40 pb-20 px-6 lg:px-12">
        <div className="max-w-3xl mx-auto">
          ...
          <h1 className="font-display text-4xl lg:text-5xl font-extrabold mb-4 text-ink">Privacy Policy</h1>
          ...
          <div className="space-y-8 text-slate leading-relaxed">
            ...
            <section>
              <h2 className="font-display text-2xl font-bold text-ink mb-4">4. Data Sharing</h2>
            ...
            <section>
              <h2 className="font-display text-2xl font-bold text-ink mb-4">5. Your Rights</h2>
            ...
            <section>
              <h2 className="font-display text-2xl font-bold text-ink mb-4">6. Cookies</h2>
            ...
            <section>
              <h2 className="font-display text-2xl font-bold text-ink mb-4">7. Data Security</h2>
