        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-5 gap-5">
          {steps.map((s) => (
            <div key={s.num} className="text-center p-8 bg-white border border-sand rounded-2xl shadow-card hover:shadow-card-hover hover:border-teal/40 transition-all">
              ...
              <h3 className="font-display text-base font-bold text-ink uppercase tracking-wide mb-3">{s.title}</h3>
      ...
      <section id="contact" className="py-24 lg:py-32 px-6 lg:px-12 max-w-7xl mx-auto scroll-mt-20">
        <div className="text-center mb-16 max-w-3xl mx-auto">
          ...
          <p className="text-slate text-lg leading-relaxed">
            Every product in the portfolio started with a conversation like this. Tell us what&rsquo;s slowing your industry down, and we&rsquo;ll tell you whether the problem is worth building a niche product around. Pick whichever way works for you.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-6 max-w-5xl mx-auto">
          {/* Email */}
          <a
            href="mailto:mick@autaimate.com"
            className="group p-8 bg-white border border-sand rounded-2xl shadow-card hover:shadow-card-hover hover:border-teal/40 hover:-translate-y-1 transition-all text-center"
          >
            <div className="contact-icon mx-auto mb-5">
              <svg className="w-7 h-7 stroke-teal" fill="none" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
              </svg>
            </div>
            <div className="text-xs font-semibold uppercase tracking-wider text-teal mb-2">Email</div>
            <h3 className="font-display text-lg font-bold text-ink mb-2 group-hover:text-teal transition-colors">mick@autaimate.com</h3>
            <p className="text-slate text-sm leading-relaxed">Quickest if you can sketch the problem in a paragraph or two.</p>
          </a>

          {/* Phone */}
          <a
            href="tel:+447501439406"
            className="group p-8 bg-white border border-sand rounded-2xl shadow-card hover:shadow-card-hover hover:border-teal/40 hover:-translate-y-1 transition-all text-center"
          >
            <div className="contact-icon mx-auto mb-5">
              <svg className="w-7 h-7 stroke-teal" fill="none" viewBox="0 0 24 24">
            ...
            <div className="text-xs font-semibold uppercase tracking-wider text-teal mb-2">Phone</div>
            <h3 className="font-display text-lg font-bold text-ink mb-2 group-hover:text-teal transition-colors">07501 439406</h3>
            <p className="text-slate text-sm leading-relaxed">Best for a proper conversation about a build idea or a quick question.</p>
          </a>

          {/* Form */}
          <a
            href="https://app.smartsuite.com/form/sba974gi/0TfuCx5I40"
            target="_blank"
          ...
          >
            ...
            <div className="text-xs font-semibold uppercase tracking-wider text-teal mb-2">Contact form</div>
            <h3 className="font-display text-lg font-bold text-ink mb-2 group-hover:text-teal transition-colors">Open the form</h3>
            <p className="text-slate text-sm leading-relaxed">Structured fields if you'd rather brief the project that way. Opens in a new tab.</p>
          </a>
        </div>

        <div className="text-center mt-12 text-sm text-slate">
          Based in the United Kingdom. Replies usually within one working day.
        </div>
      </section>
    </Layout>
  )
