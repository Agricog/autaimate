        ...
        <div className="max-w-7xl mx-auto">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center animate-slide-up delay-200 opacity-0" style={{ animationFillMode: 'forwards' }}>
              ...
              <a href="#contact" className="inline-flex items-center justify-center px-8 py-4 rounded-xl bg-slate-800 text-white font-semibold text-lg border border-slate-700 hover:bg-slate-700 hover:border-slate-600 transition-all">
                Get in Touch
              </a>
            </div>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="font-display text-4xl sm:text-5xl font-bold text-white mb-6">
                Built for <span className="gradient-text">Real Problems</span>
              </h2>
